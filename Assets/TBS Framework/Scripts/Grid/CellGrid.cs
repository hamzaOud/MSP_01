...
namespace TbsFramework.Grid
{
    ...
    /// </summary>
    public class CellGrid : PunBehaviour, IPunTurnManagerCallbacks
    {
        /// <summary>
        ...
        private int nextUpdateCall = 1;

        private int playerID;

        public PhotonView pView { get { return this.gameObject.GetComponent<PhotonView>(); } }
        ...
        private void Start()
        {
            ...
            this.turnManager.TurnDuration = 200f;
        ...
        private void Update()
        {
            ...
            /*if (Time.time >= nextUpdateCall)
            {
                // Change the next update (current second+1)
                nextUpdateCall = Mathf.FloorToInt(Time.time) + 1;
                // Call your fonction
                print("turnmanager.turn: " + this.turnManager.Turn);
                print("currentplayernumber: " + CurrentPlayerNumber);
        ...
        private void OnCellClicked(object sender, EventArgs e)
        {
            ...
            Cell caca = sender as Cell;

            object[] datas = new object[] { caca.cellID };
            ...
            PhotonNetwork.RaiseEvent((byte)PhotonEventCodes.CellClicked, datas, false, options);
            Debug.Log("calling raise event");
        ...
        private void OnPhotonEvent(byte eventCode, object content, int senderID)
        {
            ...
            if (code == PhotonEventCodes.CellClicked)
            {
                object[] datas = content as object[];



                foreach(Cell pipi in Cells)
                {
                    if(pipi.cellID == (int)datas[0])
                    {
                        CellGridState.OnCellClicked(pipi);
                    }
                }
